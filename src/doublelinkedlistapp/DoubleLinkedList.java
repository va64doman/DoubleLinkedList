...
public class DoubleLinkedList 
{
    ...
    public void addNeighbourInBetween(String name, int pos)
    {
        ...
        // If user selected after the end neighbour, set this neighbour at
        // the end of the list
        if(pos == 1)
        {
    ...
    public void displayNeighbour(int pos)
    {
        ...
        if(!isEmpty()){
            ...
            for(int count = 1; count <= size; count++)
            {
                ...
                if(count == pos)
                {
                    // Display the neighbour's details with the name of previous and next neighbour
                    System.out.println(pointer.printNeighbour());
                    if(pointer.getPreviousNeighbour() != null)
                    {
                        System.out.println("The previous neighbour is " + pointer.getPreviousNeighbour().getName());
                    }
                    else
                    {
                        System.out.println("There is no previous neighbour for this neighbour.");
                    }
                    if(pointer.getNextNeighbour() != null)
                    {
                        System.out.println("The next neighbour is " + pointer.getNextNeighbour().getName());
                    }
                    else
                    {
                        System.out.println("There is no next neighbour for this neighbour.");
                    }
                    found++;
                }
                // Set pointer to the next neighbour
    ...
    public void changeNeighbourDetail(int pos)
    {
        if(!isEmpty())
        {
            ...
            // Check if the neighbour is existed
            if(found > 0)
            {
            ...
            {
                // If position is not found, display this message
                System.out.println("The neighbour is not existed.");
            }
        }
        else
        {
            // If the street is empty, display this message
            System.out.println("The street is empty.");
        }
    }
    // Display all options
